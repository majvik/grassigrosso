    ...
    <>
      ...
      <section className="documents-certification">
        ...
        <div className="documents-certification-grid">
          {certificates.map((document) => (
            <div className="documents-cert-card" data-document={document.id} key={document.id}>
              ...
              <div className="documents-cert-footer">
                <a href="#" className="documents-cert-download" data-request-document>
                  ЗАПРОСИТЬ
          ...
          <div className="documents-commercial-right">
            <div className="documents-commercial-list">
              {companyDocuments.map((document) => (
                <div className="documents-commercial-item" data-document={document.id} key={document.id}>
      ...
      <section className="documents-faq">
        ...
        <div className="faq-list">
          {faqItems.map((item) => (
            <div className={item.active ? 'faq-item active' : 'faq-item'} key={item.question}>
