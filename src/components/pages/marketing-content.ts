        ...
        <div class="catalog-hero-content">
          <div class="catalog-hero-text">
            ...
            <p class="catalog-hero-description">
              Мы создаем продуманные системы для сна и естественного восстановления, чтобы каждое утро начиналось легко и спокойно. Подберите матрас под ваши задачи: формат использования, уровень жесткости и требуемую нагрузку.
            </p>
          </div>
              ...
              <div class="catalogue-new-filter-field">
                ...
                <div class="catalogue-new-size-select" data-size-group="size">
                  ...
                  <ul class="catalogue-new-size-select-menu" role="listbox" hidden>
                    ...
                    <li><button type="button" class="catalogue-new-size-select-option" data-value="200x200">200 × 200</button></li>
                    <li><button type="button" class="catalogue-new-size-select-option" data-value="140x220">140 × 220</button></li>
                    <li><button type="button" class="catalogue-new-size-select-option" data-value="160x220">160 × 220</button></li>
                    <li><button type="button" class="catalogue-new-size-select-option" data-value="180x220">180 × 220</button></li>
                    <li><button type="button" class="catalogue-new-size-select-option" data-value="200x220">200 × 220</button></li>
                    <li><button type="button" class="catalogue-new-size-select-option" data-value="220x220">220 × 220</button></li>
                  </ul>
                </div>
              </div>
            </div>
