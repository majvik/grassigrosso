  ...
  return (
    <>
      <section className="page-hero">
        <div className="page-hero-content">
          ...
          <div className="page-hero-image">
            <picture>
              <source type="image/avif" srcSet="/dealers-hero@2x.avif 2x, /dealers-hero.avif 1x" />
              <source type="image/webp" srcSet="/dealers-hero@2x.webp 2x, /dealers-hero.webp 1x" />
              <source type="image/png" srcSet="/dealers-hero@2x.png 2x, /dealers-hero.png 1x" />
              <img src="/dealers-hero.png" alt="Интерьер спальни" />
            </picture>
          </div>
        </div>
      ...
      <section className="conditions-section">
        ...
        <div className="conditions-icon"><img src="/icon-hand-pointer.svg" alt="Иконка руки с указателем для условий участия" /></div>
      </section>
      ...
      <section className="offers-section">
        ...
        <div className="offers-grid">
          <div className="offer-card">
            <div className="offer-icon"><img src="/icon-megaphone.svg" alt="Иконка мегафона для маркетинговой поддержки" /></div>
          ...
          <div className="offer-card">
            <div className="offer-icon"><img src="/icon-truck.svg" alt="Иконка грузовика для логистики и сервиса" /></div>
      ...
      <section className="geography-section">
        ...
        <div className="geography-map" id="geographyMapContainer"><img src="/Map.svg" alt="География дилеров" id="geographyMapImg" /></div>
      ...
      <section className="quality-section">
        <div className="quality-content-wrapper">
          ...
          <div className="quality-image" id="qualityVideo">
            <video className="quality-video" poster="/quality-video-poster.avif" autoPlay loop muted playsInline>
              <source src="/quality-video.webm" type="video/webm" />
              <source src="/quality-video.mp4" type="video/mp4" />
            </video>
            <picture className="quality-poster">
              <source type="image/avif" srcSet="/quality-video-poster.avif" />
              <source type="image/webp" srcSet="/quality-video-poster.webp" />
              <img src="/quality-video-poster.jpg" alt="Производство" />
            </picture>
