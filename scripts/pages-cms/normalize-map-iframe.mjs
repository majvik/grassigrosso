 ...
 * Used by Strapi feeds (Phase C) and re-checked at Node boundary (Phase D).
 */
import { MAP_EMBED_ALLOWED_HOSTS, MAP_EMBED_PATH_PREFIX } from './constants.mjs'

/**
 * @param {unknown} html
 * @returns {string | null}
 */
export function normalizeMapIframeHtml(html) {
