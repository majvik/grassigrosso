...
## 5) Почему это сильная инженерная реализация
...
### 5.1) Почему лоадер сделан сильно (по-инженерному)
...
### 5.2) Почему хранение и отдача картинок сделаны правильно
...
### 5.3) Почему это сильная работа разработчика (peer-review аргументы)
...
- Реализован email-канал доставки через SMTP.
- Реализована стратегия primary/secondary каналов.
- Реализована очередь ретраев с backoff.
- Добавлен SMTP-диагностический endpoint для эксплуатации.
